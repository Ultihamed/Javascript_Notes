...
- In **JavaScript**, inserting an element more than once will move it ant not copy it. Because an element is an object and **JavaScript** use its reference to move that.
