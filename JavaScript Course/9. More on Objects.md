...
- There is a shorthand way for adding a method to an object in **JavaScript**. You can omit the colon (`:`) and the `function` keyword (omit the arrow of course). For example:
