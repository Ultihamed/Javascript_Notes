...
- An operator has been proposed for **JavaScript** to perform expotentiation in the same way that `Math.pow(..)` does. For example:
...
- Consider:
    ...
    console.log(o3.a, o3.b, o3.d);
    // 1 2 3 4
    ```

    The `...` operator might also be used to gather an object's destructed properties back into an object:
